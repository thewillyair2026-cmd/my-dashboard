...
insert into sales_deal_type_monthly (sort_order, ym, b2b_count, b2c_count, b2b_revenue, b2c_revenue) values
  ...
  (3,'2025.11', 32, 79, 150313174, 366548695),
  (4,'2025.12', 32, 87, 163265261, 407190861),
  (5,'2026.01', 54, 119,263169984, 586189637),
  (6,'2026.02', 42, 98, 208876262, 474973685),
  (7,'2026.03', 54, 165,278195891, 834826363),
  (8,'2026.04', 56, 177,281157707, 891266797),
  (9,'2026.05', 53, 105,275910768, 531312390),
  (10,'2026.06',74, 93, 363876335, 469956965),
  (11,'2026.07',58, 108,303599979, 541864048),
