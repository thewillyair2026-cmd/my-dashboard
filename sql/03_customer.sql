...
create policy "read" on customer_summary  for select to anon using (true);
create policy "read" on customer_as_cohort for select to anon using (true);
create policy "read" on customer_type     for select to anon using (true);
create policy "read" on b2b_partners      for select to anon using (true);
